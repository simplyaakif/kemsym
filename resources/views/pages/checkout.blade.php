        ...
        <div class="container">
            <div class="row">
                    ...
                    <form class="needs-validation" novalidate="">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="firstName" placeholder="" value="Lorem"
                                    required="">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="lastName" placeholder="" value="Ipsum"
                                    required="">
                                <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="username" value="myemailuser" placeholder="Username"
                                    required="">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="address" placeholder="1234 Main St" value="lorem ipsum dolor seit"
                                required="">
                            <div class="invalid-feedback">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input disabled value="90001" type="text" class="form-control" id="zip" placeholder=""
                                    required="">
                                <div class="invalid-feedback">
                                    Zip code required.
                                </div>
                        ...
                        <div class="custom-contro custom-checkbox">
                            ...
                            <label class="custom-contro-label" for="same-address">Shipping address is the same as my
                ...
                <div class="col-md-8">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-mid">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><img width="60" class="img-fluid" src="{{$product['item']['img_path']}}" />
                                            </td>
                                            <td class="my-auto">
                    ...
                    <fe-checkout :products="{{ json_encode($products) }}">
                    </fe-checkout>
                </div>
